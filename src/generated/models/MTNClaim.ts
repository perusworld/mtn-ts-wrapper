 ...
 */
export function instanceOfMTNClaim(value: object): boolean {
    return true;
}

export function MTNClaimFromJSON(json: any): MTNClaim {
    return MTNClaimFromJSONTyped(json, false);
}

export function MTNClaimFromJSONTyped(json: any, ignoreDiscriminator: boolean): MTNClaim {
    if (json == null) {
        return json;
    }
    return {
...
export function MTNClaimToJSON(value?: MTNClaim | null): any {
    if (value == null) {
        return value;
    }
    return {
