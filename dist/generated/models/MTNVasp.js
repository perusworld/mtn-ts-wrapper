...
exports.MTNVaspToJSON = exports.MTNVaspFromJSONTyped = exports.MTNVaspFromJSON = exports.instanceOfMTNVasp = void 0;
 ...
 */
function instanceOfMTNVasp(value) {
    return true;
}
exports.instanceOfMTNVasp = instanceOfMTNVasp;
function MTNVaspFromJSON(json) {
    return MTNVaspFromJSONTyped(json, false);
}
exports.MTNVaspFromJSON = MTNVaspFromJSON;
function MTNVaspFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.MTNVaspFromJSONTyped = MTNVaspFromJSONTyped;
function MTNVaspToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.MTNVaspToJSON = MTNVaspToJSON;
//# sourceMappingURL=MTNVasp.js.map